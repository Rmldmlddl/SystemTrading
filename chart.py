...
from PyQt5.QtChart import QLineSeries, QChart, QValueAxis, QDateTimeAxis  # QLineSeries: manage chart data, QChart: drawing line space
from PyQt5.QtGui import QPainter  # QPainter: for antialiasing
...
class ChartWidget(QWidget):
    def __init__(self, parent=None, ticker="BTC"):
        ...
        uic.loadUi("resources/chart.ui", self)
        self.ticker = ticker
